...
/// mediaremote-adapter helper (see Lyrics/MediaRemoteAdapter/ for what that is and why it's
...
struct NowPlayingInfo: Equatable {
    ...
    /// (like scrolling lyrics) needs to extrapolate between samples itself rather than only ever
...
/// One timed line of lyrics, as parsed from an LRC file by LRCParser.
