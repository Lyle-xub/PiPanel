...
private enum SettingsSection: String, CaseIterable, Identifiable {
    case general, appearance, advanced, membership, permissions, about
    ...
    var subtitle: String {
        switch self {
        case .general: return "画面质量、自动化与默认行为"
        case .appearance: return "窗口样式、边框与堆叠外观"
        case .advanced: return "歌词、关闭行为与全局快捷键"
        case .membership: return "查看许可证与专业版状态"
    ...
    var icon: String {
        ...
        case .membership: return "star.fill"
